...
#define FREERETURN {free_vector(fvec,1,n);free_vector(xold,1,n); free_vector(w,1,n);free_vector(t,1,n);free_vector(s,1,n); free_matrix(r,1,n,1,n);free_matrix(qt,1,n,1,n);free_vector(p,1,n); free_vector(g,1,n);free_vector(fvcold,1,n);free_vector(d,1,n); free_vector(c,1,n);return;}
